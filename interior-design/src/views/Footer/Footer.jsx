...
const Footer = () => {
    return (
        <div className='bg-[linear-gradient(133deg,_#566270_0%,_#283444_100%)]'>
            <div className='max-w-[1490px] mx-auto px-10 py-[60px]'>
                <div className='flex flex-col items-center xl:items-start xl:flex-row xl:justify-between gap-12'>
                    <div className='w-full xl:w-auto flex flex-col items-center xl:items-start'>
                        ...
                        <div className='relative w-full xs:w-[380px] xl:w-[320px] mt-11'>
                            ...
                            />
                            <div className='absolute top-2/4 -translate-y-2/4 right-3 bg-gradient-to-r from-green-400 to-blue-400  
                                px-6 py-2.5 rounded-full cursor-pointer text-white capitalize'
                            >
                                subscribe
                            </div>
                        </div>
                        ...
                        <div className='flex flex-col xs:flex-row gap-12 w-full md:w-auto'>
                            {footerLinksColumnOne.map((item, index) => (
                                <div key={index} className='text-white max-w-screen md:max-w-[340px] flex-1 md:flex-auto'>
                                    <h6 className='text-center mb-8 text-base lg:text-lg font-bold md:text-center xl:text-start'>
                                        {item.title}
                                    </h6>
                                    <ul className='flex flex-col gap-4'>
                                        {item.links.map((link, index) => (
                                            <div key={`list-item-${index}`} className='w-full mx-auto flex justify-center xl:justify-start'>
