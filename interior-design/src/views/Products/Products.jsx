...
import { productsTitle, productsBtnText, products } from '../../fixtures/data'
            ...
            <FadeIn delay={0.2} direction={"right"}>
                <div className='flex flex-col'>
                    ...
                    <button 
                        ...
                        border hover:border-black outline-none focus:outline-none ease-linear transition-all duration-300 mx-auto 2xl:mx-0 mb-10 2xl:mb-0'
                    >
                    ...
                    <FadeIn key={index} delay={(index + 1) * 0.2} direction={"left"} fullWidth >
                        <div className='h-[510px] relative flex-1 bg-[#C1D0E4] rounded-[50px]  max-w-[500px]'>
                            <img 
                                src={product.img} 
                                alt={product.title} 
                                className='absolute -top-[120px] left-1/2 -translate-x-1/2 w-full'
                            />
                            <div className='absolute bottom-0 w-full bg-white h-[260px] rounded-[50px] shadow-md px-8 py-[26px] flex flex-col justify-between'>
                                ...
                                <div className="flex justify-between items-center">
                                    ...
                                    <img src={plusIcon} alt="plusIcon" className='cursor-pointer h-10 w-10 xs:h-12 xs:w-12'/>
                                </div>
                            </div>
